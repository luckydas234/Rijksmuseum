...
public class OpenWeatherController {
	...
	public void tempratureSearchByCityNameController( String sTempinCelcius, WeatherPOJO weather)
			throws Exception {
   ...
   logger.info( "Response Temprature is =>"+response.getBody().jsonPath().get("main.temp").toString().substring(0, 2));
   weather.setApiTemprature(Integer.parseInt(response.getBody().jsonPath().get("main.temp").toString().substring(0, 2)));
